...
<head>
    <meta charset="UTF-8">
    <title>Welcome to HMVC Project!</title>
...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="https://github.com/ricopie/CodeIgniter4-HMVC/issues" target="_blank">Report Issues</a></li>
        </ul>
    </div>
    ...
    <div class="heroe">
        ...
        <h2>The small framework with powerful features and integrated to HMVC Modules</h2>
...
<section>
    ...
    <p>Hello there, this is <b>Hierarchical-Model-View-Controller</b> (HMVC) project.</p>

    <p>The page you are looking at is being generated dynamically by CodeIgniter.</p>

    <p>If you would like to edit this page you will find it located at:</p>

    <pre><code>app/Modules/Welcome/Views/welcome_message.php</code></pre>

    <p>The corresponding controller for this page can be found at:</p>

    <pre><code>app/Modules/Welcome/Controllers/Welcome.php</code></pre>
